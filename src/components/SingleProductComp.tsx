    ...
    <div className="width px-4 py-4 3xl:px-0">
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div className="image-slider">
          <div className="img mb-4 flex aspect-video w-full items-center justify-center rounded-[21px] relative  bg-grey p-4">
            <img
              src={productImage}
              alt={data.name}
        ...
        <div className="product-details">
                  ...
                  <div className="my-3 flex flex-wrap items-center gap-4">
                    {splitTags(variant.variations).map(function (variantion) {
                      return (
                        ...
                        <Button
                          variant={"outline"}
                          onClick={() => checkVariant(variant.name, variantion)}
                          className={`relative w-fit rounded-full border-[#707070] font-bold hover:border-primary 2xl:p-6 2xl:text-[20px] min-w-[150px] ${
          ...
          {formError.error === "success" && (
            ...
            <div className="flex flex-wrap gap-4 justify-between">
              ...
              <Button className="w-full rounded-full font-bold sm:w-[60%] 2xl:p-6 2xl:text-[20px]" disabled={loading} onClick={()=>addToCart()}>
                ADD TO CART
              </Button>
            </div>
