...
const AddNewShippingCounty = (props:Props) => {
    ...
    const county = api.counties.addnew.useMutation();
    const onSubmit = async (values: z.infer<typeof shippingCountySchema>) => {
        // console.log(values)
        startTransition(async () => {
          try {
            const apiResult = await county.mutateAsync(values,{onSuccess: () => {
              router.refresh();
            },});
...
export default AddNewShippingCounty